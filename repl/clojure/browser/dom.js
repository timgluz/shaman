...
append.cljs$lang$applyTo = (function (arglist__4823){
var parent = cljs.core.first(arglist__4823);
var children = cljs.core.rest(arglist__4823);
...
var _element = null;
var _element__1 = (function (this$){if((function (){var and__3213__auto__ = this$;if(and__3213__auto__)
...
{var x__3818__auto__ = (((this$ == null))?null:this$);return (function (){var or__3222__auto__ = (clojure.browser.dom._element[goog.typeOf(x__3818__auto__)]);if(or__3222__auto__)
{return or__3222__auto__;
} else
{var or__3222__auto____$1 = (clojure.browser.dom._element["_"]);if(or__3222__auto____$1)
...
var _element__2 = (function (this$,attrs_or_children){if((function (){var and__3213__auto__ = this$;if(and__3213__auto__)
...
var _element__3 = (function (this$,attrs,children){if((function (){var and__3213__auto__ = this$;if(and__3213__auto__)
...
log.cljs$lang$applyTo = (function (arglist__4824){
...
var G__4828 = null;
var G__4828__1 = (function (this$){clojure.browser.dom.log.call(null,"string (-element ",this$,")");
...
var G__4828__2 = (function (this$,attrs_or_children){clojure.browser.dom.log.call(null,"string (-element ",this$," ",attrs_or_children,")");
...
var G__4828__3 = (function (this$,attrs,children){clojure.browser.dom.log.call(null,"string (-element ",this$," ",attrs," ",children,")");
var str_attrs = (((cljs.core.map_QMARK_.call(null,attrs)) && (cljs.core.seq.call(null,attrs)))?cljs.core.reduce.call(null,(function (o,p__4825){var vec__4826 = p__4825;var k = cljs.core.nth.call(null,vec__4826,0,null);var v = cljs.core.nth.call(null,vec__4826,1,null);var o__$1 = (((o == null))?{}:o);clojure.browser.dom.log.call(null,"o = ",o__$1);
...
{var G__4827 = o__$1;(G__4827[cljs.core.name.call(null,k)] = v);
return G__4827;
} else
{return null;
}
...
G__4828 = function(this$,attrs,children){
switch(arguments.length){
case 1:
return G__4828__1.call(this,this$);
case 2:
return G__4828__2.call(this,this$,attrs);
case 3:
return G__4828__3.call(this,this$,attrs,children);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
return G__4828;
...
var G__4829__delegate = function (tag,children){clojure.browser.dom.log.call(null,"(element ",tag," ",children,")");
...
var G__4829 = function (tag,var_args){
var children = null;if (arguments.length > 1) {
  children = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__4829__delegate.call(this,tag,children);};
G__4829.cljs$lang$maxFixedArity = 1;
G__4829.cljs$lang$applyTo = (function (arglist__4830){
var tag = cljs.core.first(arglist__4830);
var children = cljs.core.rest(arglist__4830);
return G__4829__delegate(tag,children);
});
...
*/
clojure.browser.dom.set_value = (function set_value(e,v){return clojure.browser.dom.set_properties.call(null,e,cljs.core.PersistentArrayMap.fromArray(["value",v], true));
});
