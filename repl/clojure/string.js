...
{{
var G__4916 = cljs.core.pop.call(null,v__$1);
v__$1 = G__4916;
continue;
}
} else
...
{var pred__4920 = cljs.core._EQ_;var expr__4921 = limit;if(pred__4920.call(null,1,expr__4921))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__4920.call(null,2,expr__4921))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__4923 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__4924 = (limit__$1 - 1);
var G__4925 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__4923;
limit__$1 = G__4924;
parts = G__4925;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___4927 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___4927))
{var replacement_4928 = temp__4090__auto___4927;buffer.append([cljs.core.str(replacement_4928)].join(''));
} else
{buffer.append(ch);
}
{
