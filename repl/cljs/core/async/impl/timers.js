...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3759__auto__,writer__3760__auto__,opt__3761__auto__){return cljs.core._write.call(null,writer__3760__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13630 = 0;while(true){
if((i_13630 < arr.length))
{(arr[i_13630] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3759__auto__,writer__3760__auto__,opt__3761__auto__){return cljs.core._write.call(null,writer__3760__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13637 = (self__.level + 1);while(true){
if((i_13637 <= (new_level + 1)))
{(update[i_13637] = self__.header);
{
var G__13638 = (i_13637 + 1);
i_13637 = G__13638;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13639 = 0;while(true){
if((i_13639 <= self__.level))
{var links_13640 = (update[i_13639]).forward;if(((links_13640[i_13639]) === x__$1))
{(links_13640[i_13639] = (x__$1.forward[i_13639]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3222__auto__ = (cljs.core.truth_((function (){var and__3213__auto__ = me;if(cljs.core.truth_(and__3213__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3213__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3222__auto__))
