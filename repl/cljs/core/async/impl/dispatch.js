...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13653 = 0;while(true){
var m_13654 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13654 == null))
{} else
{m_13654.call(null);
if((count_13653 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13655 = (count_13653 + 1);
count_13653 = G__13655;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3213__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3213__auto__)
